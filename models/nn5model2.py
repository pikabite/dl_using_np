...
class NN5model2 :
    ...
    def lrelu (self, input_data, a=0.2) :
        return input_data*((input_data >= 0)*1 + (input_data < 0)*a)
    ...
    def dsce (self, loss, softmax, y) :
        ...
        # return np.mean(softmax - y_onehot, axis=0)

    def dlrelu (self, input_d, input_data, a=0.2) :
        return input_d * (((input_data >= 0)*1) + ((input_data < 0)*a))
...
# b_images, b_labels = dloader.get_batch(0, 10)
